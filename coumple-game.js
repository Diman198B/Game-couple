        ...
        function crateCardArrow() {
          for (let i = 0; i < numberOfCards; ++i) {
            ...
            if (coumpleItem.item.dataset.framework % 2 === 1) {
              coumpleItem.item.setAttribute(
                "data-framework",
                coumpleItem.item.dataset.framework - 1
              );
            }
          ...
          intervalNumber = setInterval(() => {
            if (countTimer.textContent <= 1) {
              ...
              for (const i of cards) {
                if (
                  document.getElementsByClassName("flip").length ==
                  numberOfCards
                ) {
